        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>{{ $employees[0]->EngagementSurvey }}</h3>

                <p>EngagementSurvey</p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <!--<a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>-->
              <a href="/dataViz" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>{{ $employees[0]->PerformanceScore }}</h3>
                <p style="color: white;">PerformanceScore</p>
              </div>
              <div class="icon">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  ...
                  <div class="chart tab-pane active" id="revenue-chart"
                      ...
                      <canvas id="predict-chart-canvas" height="300" style="height: 300px;"></canvas>
                      ...
                      <script>
                      //phpから値を受け取る
                      let predict = JSON.parse('<?php echo $predict; ?>');
                      console.log(predict)
                      
                      let test_X = predict.map(function(item) {
                        return item.test_X;
                      });
                      
                      let test_Y = predict.map(function(item) {
                        return item.test_Y;
                      });
                      
                      //以下，グラフを表示
                      var ctx = document.getElementById("predict-chart-canvas");
                        var prediChart = new Chart(ctx, {
                          type: 'line',
                          data: {
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-left">Login Name</span>
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{ asset('ist/img/user3-128x128.jpg')}}d" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
